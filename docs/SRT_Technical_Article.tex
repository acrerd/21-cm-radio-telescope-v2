...
All endpoints accept HTTP GET requests. Base URL is the ESP32's IP address (e.g.\ \texttt{http://192.168.0.149}).
...
# Track RA/Dec (J2000)
curl "http://192.168.0.149/track/radec?ra=12.5&dec=-30"

# Track galactic coordinates
curl "http://192.168.0.149/track/galactic?l=0&b=0"

# Track Sun / Moon
curl "http://192.168.0.149/track/sun"
curl "http://192.168.0.149/track/moon"

# Direct alt/az slew
curl "http://192.168.0.149/direct?alt=45&az=180"

# Stop tracking
curl "http://192.168.0.149/tracking/enable?enable=0"

# Get status
curl "http://192.168.0.149/status"

# Get ephemeris (Sun and Moon positions)
curl "http://192.168.0.149/ephemeris"

# Calibrator on/off
curl "http://192.168.0.149/calibrator?on=1"
curl "http://192.168.0.149/calibrator?on=0"

# Get settings (includes observer location)
curl "http://192.168.0.149/settings"
\end{lstlisting}
