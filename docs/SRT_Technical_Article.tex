...
\begin{description}[style=nextline]
    \item[Scheduler tab] Main view for managing observations. Supports add, edit, clone, and delete. Running observations are protected from editing. Includes clash prevention, late-start recovery, preemption of running observations, audio notifications, and a countdown to the next scheduled observation.
    \item[Configuration tab] Persistent settings: controller URL, observer location (latitude, longitude, elevation), slew timeout, Python executable path, data output folder, minimum satellite pass elevation, banner name, and sound toggle.
    \item[Log tab] Displays the last $N$ lines of \texttt{scheduler.log} with auto-refresh.
\end{description}
